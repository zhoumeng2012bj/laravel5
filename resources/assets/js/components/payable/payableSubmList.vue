					...
					<template slot-scope="scope">
						<el-dropdown menu-align="start">
							...
							<el-dropdown-menu slot="dropdown">
								<el-dropdown-item>
									<el-button @click="handleView(scope.$index, scope.row)">查看备注</el-button>
								</el-dropdown-item>
								<el-dropdown-item v-if="ztin(scope.row,[2,3,4,5,6])">
									<el-button @click="handleAdd(scope.$index, scope.row)">审批记录</el-button>
								</el-dropdown-item>
								<el-dropdown-item v-if="fun('paSubListDedList')">
									<el-button @click="handleviewRokeBack(scope.$index,scope.row)">扣款记录</el-button>
								</el-dropdown-item>
								<el-dropdown-item>
