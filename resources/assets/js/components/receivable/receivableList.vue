	...
	<el-row>
					...
					<template slot-scope="scope">
						<el-dropdown menu-align="start">
							...
							<el-dropdown-menu slot="dropdown">
								...
								<el-dropdown-item v-if="ztin(scope.row,[1,2,3])&&fun('submissionRecords')">
		...
		<el-dialog title="提交收款" v-model="rokeBackFormVisible" :close-on-click-modal="false">
			<el-form :model="rokeBackForm" label-width="120px" :rules="rokeBackFormRules" ref="rokeBackForm">
				...
				<el-form-item label="备注：" prop="beizhu">
					<el-input type="textarea" :rows="5" placeholder="请输入内容" v-model="rokeBackForm.beizhu">
					</el-input>
				</el-form-item>
			</el-form>
		...
		<el-dialog :title="YXJ" v-model="addFormVisible" :close-on-click-modal="false">
			<el-form :model="addForm" label-width="100px" :rules="addFormRules" ref="addForm">
				...
				<el-form-item label="备注：" prop="beizhu">
					<el-input type="textarea" :rows="5" placeholder="请输入内容" v-model="addForm.beizhu">
					</el-input>
				</el-form-item>
