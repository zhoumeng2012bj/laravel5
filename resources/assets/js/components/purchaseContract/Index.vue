                ...
                <template slot-scope="scope">
                    <el-dropdown   menu-align="start">
                        ...
                        <el-dropdown-menu slot="dropdown" >
                            ...
                            <el-dropdown-item  v-if="ztin(scope.row,[6,7,8,9,10,11])&&fun('purchaseContactAppZH')"><el-button @click="handleAppZhanghao(scope.$index, scope.row)">用户账号管理</el-button></el-dropdown-item>
...
<script>
    ...
    export default {
        ...
        methods: {
			...
			//优化跟进记录
			handleOfur(index,row){
				// window.open('/#/purchaseContract/ofur?id='+row.id);
