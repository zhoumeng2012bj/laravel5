<template>
    <div class="whole">
        ...
        <p>丙方（资产管理方）：<input type="text" style="width: 450px" disabled/></p>
 ...
 -->
            ...
            <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（二）在承租期内，乙方自行承担在使用期间的相关费用（水费、电费、燃气费、宽带费、停车费、能源押金、制冷费、冷暖转换费等），乙方按物业管理机构提供的交费通知单交费。
            <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（三）在承租期内，乙方需要在此房间内报装电话、宽带的，相关费用由乙方自行承担。
            <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（四）本合同租金<span v-if="addDate.housetax==2" style="display: inline;">仅</span>含物业费、供暖费<span v-if="addDate.housetax==2" style="display: inline;">，不含</span><span v-if="addDate.housetax==1"style="display: inline;">、</span>出租房屋需缴纳的税费，出租房屋所产生的税费由乙方全部承担并缴纳。甲方向乙方提供身份证明及房屋所有权证复印件，由乙方自行到税务部门开具房租增值税普通发票。
            <br><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第六条  甲方的权利义务</b>
